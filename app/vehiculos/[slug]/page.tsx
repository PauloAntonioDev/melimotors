        ...
        <div className="grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-start">
          ...
          <div className="rounded-[22px] border border-[#d9e4ef] bg-white p-6 shadow-[0_14px_40px_rgba(31,35,31,0.05)] sm:p-8">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <a href={`https://wa.me/56900000000?text=${whatsappMessage}`} target="_blank" rel="noreferrer" className="inline-flex flex-1 items-center justify-center gap-2 rounded-full bg-[#0b8a9e] px-5 py-3.5 text-sm font-bold text-white transition hover:bg-[#086a7d]"><MessageCircle size={17} aria-hidden="true" /> Consultar por WhatsApp</a>
              <a href="#consulta" className="inline-flex flex-1 items-center justify-center gap-2 rounded-full border border-[#b8c9da] px-5 py-3.5 text-sm font-semibold text-[#17324f] transition hover:bg-[#f5f9fd]"><ArrowRight size={17} aria-hidden="true" /> Dejar mis datos</a>
            </div>
          </div>
        </div>
          ...
          <div id="consulta" className="scroll-mt-8 rounded-[22px] border border-[#d9e4ef] bg-white p-6 shadow-[0_14px_40px_rgba(31,35,31,0.05)] sm:p-8">
            {submitted ? (
              ...
              <form onSubmit={handleLeadSubmit} className="space-y-4">
                ...
                <button disabled={submitting} className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#176bff] px-5 py-3.5 text-sm font-bold text-white transition hover:bg-[#0d52d6] disabled:cursor-wait disabled:opacity-60">{submitting ? "Enviando..." : "Enviar consulta"} <ArrowRight size={17} aria-hidden="true" /></button>
