...
import { ArrowLeftRight, ArrowRight, Check, HandCoins, ImagePlus, Store, Upload } from "lucide-react";
...
export default function SellPage() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#f7f9fc] text-[#071a33]">
      ...
      <section className="mx-auto max-w-[1240px] px-5 pb-14 pt-[170px] text-center sm:px-8 sm:pb-20"><span className="inline-flex rounded-full border border-[#9cc9ff] bg-[#eaf4ff] px-4 py-2 text-sm font-semibold text-[#176bff]">Vende tu auto</span><h1 className="mt-5 text-5xl font-semibold leading-[0.98] tracking-[-0.07em] text-[#071a33] sm:text-7xl">Elige cómo vender</h1><p className="mx-auto mt-5 max-w-[680px] text-lg leading-8 text-[#5c7082]">Tres alternativas para encontrar el camino que más te conviene.</p>
      </section>
      ...
      <section className="border-y border-[#d9e4ef] bg-white">
        <div className="mx-auto max-w-[1240px] px-5 py-14 sm:px-8 sm:py-20"><div className="grid gap-5 md:grid-cols-2">
          <article className="rounded-[16px] border border-[#176bff] bg-[#eaf4ff] p-6 text-left sm:p-8"><span className="flex h-12 w-12 items-center justify-center rounded-full bg-white text-[#176bff]"><HandCoins size={23} aria-hidden="true" /></span><p className="mt-6 text-xs font-bold uppercase tracking-[0.18em] text-[#176bff]">La forma más rápida</p><h2 className="mt-2 text-2xl font-semibold tracking-[-0.04em]">Compra directa</h2><p className="mt-3 text-sm leading-6 text-[#5c7082]">Analizamos tu vehículo y, si se ajusta a nuestro inventario, te presentamos una propuesta directa para conversar.</p><ul className="mt-6 space-y-3 text-sm font-medium text-[#17324f]"><li className="flex items-center gap-2"><Check size={17} className="text-[#176bff]" aria-hidden="true" /> Evaluación inicial con tus antecedentes.</li><li className="flex items-center gap-2"><Check size={17} className="text-[#176bff]" aria-hidden="true" /> Propuesta clara para conversar.</li><li className="flex items-center gap-2"><Check size={17} className="text-[#176bff]" aria-hidden="true" /> Ideal si necesitas vender pronto.</li></ul></article>
          <article className="rounded-[16px] border border-[#d9e4ef] bg-white p-6 text-left sm:p-8"><span className="flex h-12 w-12 items-center justify-center rounded-full bg-[#eaf4ff] text-[#176bff]"><Store size={23} aria-hidden="true" /></span><p className="mt-6 text-xs font-bold uppercase tracking-[0.18em] text-[#176bff]">El mejor camino para publicar</p><h2 className="mt-2 text-2xl font-semibold tracking-[-0.04em]">Consignación virtual</h2><p className="mt-3 text-sm leading-6 text-[#5c7082]">Publicamos tu vehículo, recibimos interesados y coordinamos el proceso contigo.</p><ul className="mt-6 space-y-3 text-sm font-medium text-[#17324f]"><li className="flex items-center gap-2"><Check size={17} className="text-[#0b8a9e]" aria-hidden="true" /> Mayor exposición en nuestro catálogo.</li><li className="flex items-center gap-2"><Check size={17} className="text-[#0b8a9e]" aria-hidden="true" /> Acompañamiento durante las conversaciones.</li><li className="flex items-center gap-2"><Check size={17} className="text-[#0b8a9e]" aria-hidden="true" /> Definimos condiciones antes de publicar.</li></ul></article>
          <article className="rounded-[16px] border border-[#d9e4ef] bg-white p-6 text-left md:col-span-2 sm:p-8"><span className="flex h-12 w-12 items-center justify-center rounded-full bg-[#eaf4ff] text-[#176bff]"><ArrowLeftRight size={23} aria-hidden="true" /></span><p className="mt-6 text-xs font-bold uppercase tracking-[0.18em] text-[#176bff]">Cambia tu auto</p><h2 className="mt-2 text-2xl font-semibold tracking-[-0.04em]">Parte de pago</h2><p className="mt-3 max-w-[650px] text-sm leading-6 text-[#5c7082]">Podemos evaluar tu auto como parte de pago para que avances hacia otro vehículo de nuestro catálogo.</p><ul className="mt-6 grid gap-3 text-sm font-medium text-[#17324f] sm:grid-cols-3"><li className="flex items-center gap-2"><Check size={17} className="text-[#176bff]" aria-hidden="true" /> Evaluación simple.</li><li className="flex items-center gap-2"><Check size={17} className="text-[#176bff]" aria-hidden="true" /> Proceso rápido.</li><li className="flex items-center gap-2"><Check size={17} className="text-[#176bff]" aria-hidden="true" /> Úsalo para cambiar de auto.</li></ul></article>
        </div><div className="mt-10 text-center"><a href="#solicitud" className="inline-flex items-center gap-2 rounded-[10px] bg-[#176bff] px-6 py-3.5 text-sm font-bold text-white transition hover:bg-[#0d52d6]">Tasá tu auto gratis <ArrowRight size={17} aria-hidden="true" /></a></div></div>
      </section>
