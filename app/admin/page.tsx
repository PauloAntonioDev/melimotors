      ...
      <main className="flex min-h-screen items-center justify-center bg-[#071a33] px-5 py-10 text-[#071a33]">
        <div className="w-full max-w-[440px] rounded-[22px] bg-[#f7f9fc] p-7 shadow-[0_24px_80px_rgba(0,0,0,0.25)] sm:p-9">
          ...
          <form onSubmit={handleLogin} className="mt-8 space-y-4">
            ...
            <button className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-full bg-[#176bff] text-sm font-bold text-white transition hover:bg-[#0d52d6]"><LogIn size={17} aria-hidden="true" /> Ingresar</button>
          </form>
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#071a33] px-5 py-10 text-[#071a33]">
        <div className="w-full max-w-[480px] rounded-[22px] bg-[#f7f9fc] p-7 text-center shadow-[0_24px_80px_rgba(0,0,0,0.25)] sm:p-9">
          ...
          <Link href="/" className="mt-7 inline-flex items-center gap-2 rounded-full bg-[#176bff] px-5 py-3.5 text-sm font-bold text-white">Volver al sitio público <ArrowLeft size={16} aria-hidden="true" /></Link>
        </div>
      </main>
    );
  }
        ...
        <section className="min-w-0 flex-1">
          ...
          <div className="mx-auto max-w-[1320px] px-5 py-8 sm:px-8 sm:py-10">
            ...
            {activeView === "overview" && <>
              ...
              <div className="mt-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center"><div><p className="text-xs font-bold uppercase tracking-[0.16em] text-[#176bff]">Inventario</p><h2 className="mt-2 text-2xl font-semibold tracking-[-0.05em]">Vehículos publicados y en preparación</h2></div><button onClick={() => setShowCreate(true)} className="inline-flex items-center justify-center gap-2 rounded-full bg-[#176bff] px-4 py-3 text-sm font-bold text-white transition hover:bg-[#0d52d6]"><Plus size={17} aria-hidden="true" /> Nuevo vehículo</button></div>
